        ...
        <div className="flex items-center gap-1.5 mt-1.5">
          <div className="flex items-center gap-1.5 flex-wrap min-w-0">
            {tags?.slice(0, 2).map((tag) => (
              <span
                key={tag.id}
                className="color-chip inline-flex items-center gap-1 max-w-[140px] text-[10px] px-1.5 py-0.5 rounded-full font-medium"
            ...
            {hasRecentAnomaly && (
              <span
                className="color-chip inline-flex items-center gap-1 max-w-[140px] text-[10px] px-1.5 py-0.5 rounded-full font-medium border"
